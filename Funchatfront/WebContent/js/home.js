...
chatworld.controller('registerController', ['$scope', 'fileUpload', function($scope,fileUpload){
    $scope.register = function(){
       ...
       console.log('file is ' );
       console.dir(file);
       var uploadUrl = "http://localhost:8088/Chatworld/fileUpload";
		...
		chatworld.controller("JobsController",function($scope,$http)
			...
			$scope.addJ=function()
			{
				...
				chatworld.controller("blogController",function($scope,$http,$rootScope)	
					...
					$http.get("http://localhost:8088/Chatworld/viewMyBlogs/"+$rootScope.uname)
							 ...
							 $scope.newBlog={};
								...
								$scope.addBlog=function(newBlog)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:8088/Chatworld/addBlog',dataObj);
									 $http.get("http://localhost:8088/Chatworld/viewMyBlogs/"+$rootScope.uname)
				...
				chatworld.controller("adminJobsController",function($scope,$http,$rootScope)	
					...
					console.log(" in jobs controller");
							 ...
							 $http.get("http://localhost:8088/Chatworld/viewJobs")
							    .then(function (response) {
							 ...
							 $scope.newJobs={};
								...
								$scope.addJobs=function(newJobs)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:8088/Chatworld/addJobs',dataObj);
									 $http.get("http://localhost:8088/Chatworld/viewJobs")
				...
				$scope.saveEdit=function()
				{
					...
					$http.put("http://localhost:8088/Chatworld/updateJob",edit);
					 $http.get("http://localhost:8088/Chatworld/viewJobs")
					    .then(function (response) {
				...
				$http.post("http://localhost:8088/Chatworld/deleteJob",del);
					 $http.get("http://localhost:8088/Chatworld/viewJobs")
					    .then(function (response) {
				...
				chatworld.controller('logoutController',function($scope,$rootScope,$http,$cookieStore)		
						{
					$http.post("http://localhost:8088/Chatworld/logout/"+$rootScope.uname);
				...
				chatworld.controller("adminForumController",function($scope,$http,$rootScope)	
					...
					console.log(" in adminforum controller");
							 ...
							 $http.get("http://localhost:8088/Chatworld/viewForums")
							    .then(function (response) {
							 ...
							 $scope.newForum={};
								...
								$scope.addForum=function(newForum)
								{
									...
									console.log("title:"+dataObj);
									 var res = $http.post('http://localhost:8088/Chatworld/addForum',dataObj);
									 $http.get("http://localhost:8088/Chatworld/viewForums")
				...
				$scope.approveForum=function()
				{
					...
					$http.put("http://localhost:8088/Chatworld/updateForum",edit);
					 $http.get("http://localhost:8088/Chatworld/viewForums")
					    .then(function (response) {
				...
				chatworld.controller("userForumController",function($scope,$http,$rootScope)	
					...
					console.log(" in forum controller");
							 ...
							 $http.get("http://localhost:8088/Chatworld/viewForum")
							    .then(function (response) {
							 ...
							 $scope.newForum={};
								...
								$scope.answer=function(forum)
								{
									...
									answer:$scope.answerforum.answer
									 ...
									 $http.post('http://localhost:8088/Chatworld/answerForum',ans);
									$http.get("http://localhost:8088/Chatworld/viewForum")
								    .then(function (response) {
								...
								$scope.viewanswers=function(forum)
								{
									...
									console.log("forumid:"+$scope.answerforum.forum_id);
									 $http.get("http://localhost:8088/Chatworld/viewAnswers/"+$scope.answerforum.forum_id)
									    .then(function (response) {
				...
				$http.post("http://localhost:8088/Chatworld/deleteForum",del)
				...
				chatworld.controller("userHomeController",function($scope,$http,$rootScope)	
					...
					console.log("name in  findfriends:"+$rootScope.uname);
							 $http.get("http://localhost:8088/Chatworld/findFriends/"+$rootScope.uname)
							    .then(function (response) {
					...
					$scope.addfriend=function(user)
					{
						...
						$http.post("http://localhost:8088/Chatworld/addFriend/",fr);
				...
				chatworld.controller("friendslistController",function($scope,$http,$rootScope)	
					...
					console.log("name in  friendslist:"+$rootScope.uname);
							 $http.get("http://localhost:8088/Chatworld/viewFriends/"+$rootScope.uname)
							    .then(function (response) {
				...
				chatworld.controller("allblogsController",function($scope,$http,$rootScope,$route)	
					...
					console.log("username in allblog controller:"+$rootScope.uname);
							 $http.get("http://localhost:8088/Chatworld/viewAllBlogs")
							    .then(function (response) {
							 ...
							 { 
						       ...
						       var like=
								...
								console.log("postedby:"+$rootScope.uname);
								 $http.put('http://localhost:8088/Chatworld/updateBlog',like);
								 $http.get("http://localhost:8088/Chatworld/viewBlogs")
								    .then(function (response) {
					 ...
					 $http.get("http://localhost:8088/Chatworld/viewComments/"+$scope.viewcomments.blog_id)
								    .then(function (response) {
						...
						$scope.comment=function(allblogs)
						{
							...
							$http.post('http://localhost:8088/Chatworld/addComment',comment);
							 $http.get("http://localhost:8088/Chatworld/viewBlogs")
							    .then(function (response) {
